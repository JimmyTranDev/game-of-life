class TestCelle {
  ...
  private static void testOppdaterStatus() {
    ...
    sjekk("celle er doed (siden <2 levende naboer)", !celle.levende);
    ...
    celle.tellLevendeNaboer();
    celle.oppdaterStatus();
    sjekk("celle forblir doed (siden 2 levende naboer)", !celle.levende);
    ...
    celle.tellLevendeNaboer();
    celle.oppdaterStatus();
    sjekk("celle blir levende (siden 3 levende naboer)", celle.levende);
    ...
    celle.tellLevendeNaboer();
    celle.oppdaterStatus();
    sjekk("celle doer (siden >3 levende naboer)", !celle.levende);
